...
const { memberAdd_schema, memberSelect_schema, memberRevise_schema, memberDel_schema, memberVerify_schema } = require('../schema/member')
...
router.post('/memberVerify', expressJoi(memberVerify_schema), memberHandler.memberVerify)
